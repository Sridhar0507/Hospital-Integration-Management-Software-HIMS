...
const RadiologyTest = () => {
    ...
    console.log("ss12", DoctorWorkbenchNavigation);
    ...
    const handleCheckboxChange = (
        ...
        const isChecked = CheckedTestName.some(
            (item) => item.SubTest_Code === SubTest_Code && item.testid === testid
        );
        ...
        if (isChecked) {
            ...
            const newCheckedState = CheckedTestName.filter(
                (item) =>
                    !(item.SubTest_Code === SubTest_Code && item.testid === testid)
            );
    ...
    const handleRemoveTestName1 = (params) => {
        ...
        const newSubtestNoState = SubtestNo.filter(
            (item) =>
                item.Radiologyid !== row.Radiologyid || item.TestCode !== row.TestCode
        );
        setSubtestNo(newSubtestNoState);
    };
    ...
    const RadiologyColumns = [
        ...
        },
        {
            ...
            name: "Sub TestName",
            renderCell: (params) =>
                params.row.SubTestName ? params.row.SubTestName : "No SubTest",
        },
        {
            key: "Action",
            name: "Action",
                        ...
                        <>
                            <div className="displayuseraccess">
                                {TestNames.map((item) => (
                                    <div key={item.id} className="displayuseraccess_child">
                                        ...
                                        {item.TestNames.filter((test) => test.Types === "No").map(
                                            (test) => (
                                                <div
                                                    key={test.id}
                                        ...
                                        {item.TestNames.filter((test) => test.Types === "Yes").map(
                                            (test) => (
                                                <div key={test.id} className="displayuseraccess_child">
                                                    ...
                                                    {test.Sub_test_data &&
                                                        test.Sub_test_data.map((subTest) => (
                                                            <div
                                                                key={subTest.id}
                                                                style={{ marginLeft: "20px", marginTop: "5px" }}
                                                            >
                                                                <input
                                                                    ...
                                                                    checked={CheckedTestName.some(
                                                                        (checkedItem) =>
                                                                            checkedItem.SubTest_Code ===
                                                                            subTest.SubTest_Code
                                                                    )}
                                                                    style={{ marginRight: "10px" }}
                                                                />
                                                                <label
                                                                    htmlFor={subTest.SubTest_Code}
                            ...
                            {transformedFavouriteData1.length > 0 && (
                                <>
                                    ...
                                    <ReactGrid
                                        columns={IndivitualColumns}
                                        RowData={transformedFavouriteData1}
                                    />
                                </>
                            )}
                            {transformedFavouriteData.length > 0 && (
                                <>
                                    ...
                                    <ReactGrid
                                        ...
                                        RowData={transformedFavouriteData}
                                    />
                                </>
                            )}

...
class CentralStore_Stock_Details(models.Model):
     
     Stock_Id=models.AutoField(primary_key=True)
     GRN_Number=models.ForeignKey(GRN_Entry_Details,on_delete=models.CASCADE)
     Stock_Item_Id=models.ForeignKey(Medical_ProductMaster_Details,on_delete=models.CASCADE)
     BatchNo=models.CharField(max_length=20)
     Manufacture_Date=models.CharField(max_length=20)
     Expiry_Date=models.CharField(max_length=20)
     ExpiryStatus=models.CharField(max_length=20,default='NotExpired')
     TotalQuantity=models.IntegerField()
     SoldQuantity=models.IntegerField(default=0)
     AvailableQuantity=models.IntegerField()
     MRP_Selling_Price_Taxable=models.DecimalField(max_digits=10,decimal_places=2)
     Tax_Percentage=models.IntegerField()
     MRP_Selling_Price=models.DecimalField(max_digits=10,decimal_places=2)
     Create_by=models.CharField(max_length=100)
     Created_at=models.DateTimeField(auto_now_add=True)
     Update_at=models.DateTimeField(auto_now=True)
